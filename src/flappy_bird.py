...
class FlappyBird(object):
    ...
    base_image = load('D:/pycode/bird/src/base.png').convert_alpha()
    background_image = load('D:/pycode/bird/src/background-black.png').convert()

    pipe_images = [rotate(load('D:/pycode/bird/src/pipe-green.png').convert_alpha(), 180),
                   load('D:/pycode/bird/src/pipe-green.png').convert_alpha()]
    bird_images = [load('D:/pycode/bird/src/redbird-upflap.png').convert_alpha(),
                   load('D:/pycode/bird/src/redbird-midflap.png').convert_alpha(),
                   load('D:/pycode/bird/src/redbird-downflap.png').convert_alpha()]
